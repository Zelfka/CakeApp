...
<div id="container">
  <NavBar></NavBar>
   <p class="background">eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel cocoa
    ...
    milk flour oil sugar cocoa cream chocolate caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel cocoa cream chocolate fruit caramel fruit chocolate
  ...
  <div class="box">
    ...
    <form v-on:submit.prevent="createCake">
      ...
      <div id="desc">
        ...
        <textarea required v-model="description" placeholder="Add details od the cake" id="desc"></textarea>
      </div>
      <div class="input">
      ...
      <div class="input">
        ...
        <input type="number" required v-model="price" placeholder="price" id="price">
      </div>
      <button type="submit"><span>Add cake</span></button>
    </form>
  </div>
