...
<div id="container">
   ...
   <p>eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel cocoa
    ...
    milk flour oil eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel
    eggs milk flour oil sugar cocoa cream chocolate cocoa fruit caramel eggs milk flour oil sugar fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel
    ...
    fruit caramel eggs flour oil sugar cocoa fruit caramel eggs milk flour oil milk eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel
    ...
    milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel
    milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel
    eggs milk flour sugar cocoa cream chocolate fruit caramel chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk fruit caramel eggs milk fruit caramel eggs
    eggs milk flour sugar cocoa cream chocolate eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk flour oil sugar cocoa cream chocolate fruit caramel eggs milk fruit caramel eggs milk fruit caramel eggs
  </p>
  <button id="home"><span><router-link :to="'/'">Home</router-link></span></button>
  <div class="form">
    <h1> Registration Form:</h1>
    <h3>Please provide your credentials to create new account.</h3>
    <p v-if="error" class="error">{{error}}</p>
    <form v-on:submit.prevent="register">
      <div class="input">
        <label for="id_username">Username:</label>
        <input type="text" placeholder="Enter your username" required v-model="username" id="id_username">
      </div>
      <div class="input">
        <label for="email">E-mail:</label>
        <input type="email" placeholder="Enter valid e-mail address" required v-model="email" id="email">
      </div>
      <div class="input">
        <label for="password">Password:</label>
        <input type="password" placeholder="At least 8 characters" required v-model="password" id="password">
      </div>
      <div class="input">
        <label for="password2">Password again:</label>
        <input type="password" placeholder="Password confirmation" required v-model="password2" id="password2">
      </div>
      <button type="submit"><span>Register</span></button>
      <h3>Already registered?</h3>
      <button id="login"><span><router-link to="login">Login</router-link></span></button>
    </form>
  </div>
</div>
</template>
